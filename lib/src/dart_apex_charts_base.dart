...
class ApexCharts {
  ...
  JsObject _callMethod(String methodName,
          [List<dynamic> options = const <dynamic>[]]) =>
      JsObject(_chart.callMethod(methodName, options) as JsFunction);
  ...
  JsObject updateOptions(Map newOptions, [bool animate = true]) => _callMethod(
